...
try {
  ...
  return (
    ...
    <div className='flex text-white'>
        <div className='w-[30%]'>
        <img alt={product.name} src={`${process.env.REACT_APP_API}/api/v1/product/product-photo/${product._id}`} className='sm:min-w-[100px] sm:max-w-[100px] sm:min-h-[100px] sm:max-h-[100px] min-w-[80px] max-w-[80px] min-h-[80px] max-h-[80px]' />
        </div>
        <div className='w-[70%]'>
