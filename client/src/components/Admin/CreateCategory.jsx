                ...
                <table className='w-[100%] border-teal-200 border'>
                    ...
                    {categories?.map((c)=>(
                        <>
                         ...
                         <td key={c._id} className='p-2'>{c.name}</td>
                         <td>
                            <button className='text-[#4d70ff] hover:underline pr-6' onClick={()=>{setVisible(true);setUpdatedName(c.name);setSelected(c)}}>Edit</button>
                            <button className='text-[red] hover:underline' onClick={()=>handleDelete(c._id)}>Delete</button>
                         </td>
                         </tr>
                        </>
                    ))}
